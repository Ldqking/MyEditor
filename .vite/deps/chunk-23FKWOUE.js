...
function useStyleRegister(info, styleFn) {
  ...
  return function(node2) {
    ...
    if (!ssrInline || isMergedClientSide || !defaultCache) {
      ...
      var _ref6;
      styleNode = React11.createElement("style", _extends({}, (_ref6 = {}, _defineProperty(_ref6, ATTR_TOKEN, cachedTokenKey), _defineProperty(_ref6, ATTR_MARK, cachedStyleId), _ref6), {
...
var DesignTokenContext = import_react3.default.createContext(defaultConfig);
...
function useToken() {
  const {
    ...
    override,
    cssVar
  } = import_react4.default.useContext(DesignTokenContext);
...
var LocaleProvider = (props) => {
  ...
  return React17.createElement(context_default.Provider, {
...
var SizeContext = React18.createContext(void 0);
var SizeContextProvider = ({
  children,
  size
}) => {
  const originSize = React18.useContext(SizeContext);
  return React18.createElement(SizeContext.Provider, {
...
// node_modules/antd/es/config-provider/MotionWrapper.js
var MotionCacheContext = React30.createContext(true);
if (true) {
...
function MotionWrapper(props) {
  ...
  if (needWrapMotionProviderRef.current) {
    return React30.createElement(MotionCacheContext.Provider, {
      value: motion
    }, React30.createElement(MotionProvider, {
      motion
    }, children));
  }
  return children;
...
export {
  ...
  unit2 as unit,
  Keyframes_default,
  en_US_default6 as en_US_default,
  useLocale_default,
  getLineHeight,
  defaultPrefixCls,
  Variants,
...
//# sourceMappingURL=chunk-23FKWOUE.js.map
