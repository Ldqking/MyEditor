...
} from "./chunk-XHIJ4TB2.js";
import {
  CheckCircleFilled_default
} from "./chunk-KFD3YAS7.js";
import {
  CheckOutlined_default
} from "./chunk-3C4S4HCH.js";
import "./chunk-HUXA7HDL.js";
import {
  CloseOutlined_default
} from "./chunk-7JMSRC2M.js";
import {
  button_default
} from "./chunk-TKNJ54LT.js";
import "./chunk-L5EPG2HS.js";
import "./chunk-EPSJL57N.js";
import {
  EyeOutlined_default
} from "./chunk-GKIVID5A.js";
import {
  CloseCircleFilled_default
} from "./chunk-RW5GJM7X.js";
import "./chunk-CKKC5RNW.js";
import "./chunk-WFJNIQUV.js";
import {
  _asyncToGenerator,
  _regeneratorRuntime
} from "./chunk-WGVWEJYT.js";
import {
...
var useId_default = function(id) {
  var _React$useState = React5.useState(), _React$useState2 = _slicedToArray(_React$useState, 2), innerId = _React$useState2[0], setInnerId = _React$useState2[1];
...
var PtgCircle = React6.forwardRef(function(props, ref) {
  ...
  var halfSize = size / 2;
  var circleNode = React6.createElement("circle", {
  ...
  return React6.createElement(React6.Fragment, null, React6.createElement("mask", {
    id: maskId
  }, circleNode), React6.createElement("foreignObject", {
    x: 0,
    y: 0,
    width: size,
    height: size,
    mask: "url(#".concat(maskId, ")")
  }, React6.createElement(Block, {
    bg: linearColorBg
  }, React6.createElement(Block, {
    bg: conicColorBg
  }))));
...
var Circle = function Circle2(props) {
  ...
  var getStokeList = function getStokeList2() {
    ...
    return percentList.map(function(ptg, index2) {
      ...
      stackPtg += ptg;
      return React7.createElement(PtgCircle_default, {
        key: index2,
        color,
        ptg,
        radius,
  ...
  var getStepStokeList = function getStepStokeList2() {
    ...
    return new Array(stepCount).fill(null).map(function(_, index2) {
      ...
      return React7.createElement("circle", {
        key: index2,
        className: "".concat(prefixCls, "-circle-path"),
        r: radius,
        cx: halfSize,
  ...
  return React7.createElement("svg", _extends({
    ...
    id,
    role: "presentation"
  }, restProps), !stepCount && React7.createElement("circle", {
...
var Circle3 = (props) => {
  ...
  const realGapDegree = React8.useMemo(() => {
  ...
  const circleContent = React8.createElement(Circle_default, {
    steps,
  ...
  const node = React8.createElement("div", {
...
var Line3 = (props) => {
  ...
  const lineInner = React9.createElement("div", {
    className: `${prefixCls}-inner`,
    style: trailStyle
  }, React9.createElement("div", {
    className: (0, import_classnames5.default)(`${prefixCls}-bg`, `${prefixCls}-bg-${infoPosition}`),
    style: percentStyle
  }, infoPosition === "inner" && children), successPercent !== void 0 && React9.createElement("div", {
    className: `${prefixCls}-success-bg`,
    style: successPercentStyle
  }));
  const isOuterStart = infoPosition === "outer" && infoAlign === "start";
  const isOuterEnd = infoPosition === "outer" && infoAlign === "end";
  return infoPosition === "outer" && infoAlign === "center" ? React9.createElement("div", {
    className: `${prefixCls}-layout-bottom`
  }, lineInner, children) : React9.createElement("div", {
...
var Steps = (props) => {
  ...
  for (let i = 0; i < steps; i++) {
    ...
    styledSteps[i] = React10.createElement("div", {
      key: i,
...
var Progress = React11.forwardRef((props, ref) => {
  const {
  ...
  const strokeColorIsBright = React11.useMemo(() => {
  ...
  const percentNumber = React11.useMemo(() => {
    var _a, _b;
    const successPercent = getSuccessPercent(props);
  ...
  const progressStatus = React11.useMemo(() => {
  ...
  const progressInfo = React11.useMemo(() => {
    if (!showInfo) {
      return null;
    }
    const successPercent = getSuccessPercent(props);
    ...
    if (infoPosition === "inner" || format || progressStatus !== "exception" && progressStatus !== "success") {
      ...
      text = isLineType ? React11.createElement(CloseCircleFilled_default, null) : React11.createElement(CloseOutlined_default, null);
    } else if (progressStatus === "success") {
      text = isLineType ? React11.createElement(CheckCircleFilled_default, null) : React11.createElement(CheckOutlined_default, null);
    }
  ...
  let progress;
  if (type === "line") {
    progress = steps ? React11.createElement(Steps_default, Object.assign({}, props, {
      strokeColor: strokeColorNotGradient,
      prefixCls,
      steps: typeof steps === "object" ? steps.count : steps
    }), progressInfo) : React11.createElement(Line_default2, Object.assign({}, props, {
    ...
    progress = React11.createElement(Circle_default2, Object.assign({}, props, {
      strokeColor: strokeColorNotArray,
      prefixCls,
      progressStatus
    }), progressInfo);
...
// node_modules/antd/es/upload/UploadList/ListItem.js
var ListItem = React12.forwardRef(({
  prefixCls,
  className,
  style,
  locale,
  ...
  const [mergedStatus, setMergedStatus] = React12.useState(status);
  React12.useEffect(() => {
    if (status !== "removed") {
      setMergedStatus(status);
    }
  }, [status]);
  const [showProgress, setShowProgress] = React12.useState(false);
  React12.useEffect(() => {
  ...
  let icon = React12.createElement("div", {
  ...
  if (listType === "picture" || listType === "picture-card" || listType === "picture-circle") {
    if (mergedStatus === "uploading" || !file.thumbUrl && !file.url) {
      ...
      icon = React12.createElement("div", {
        className: uploadingClassName
      }, iconNode);
    } else {
      const thumbnail = (isImgUrl === null || isImgUrl === void 0 ? void 0 : isImgUrl(file)) ? React12.createElement("img", {
  ...
  const removeIcon = (typeof showRemoveIcon === "function" ? showRemoveIcon(file) : showRemoveIcon) ? actionIconRender(
    (typeof customRemoveIcon === "function" ? customRemoveIcon(file) : customRemoveIcon) || React12.createElement(DeleteOutlined_default, null),
    () => onClose(file),
    prefixCls,
    locale.removeFile,
  ...
  const downloadIcon = (typeof showDownloadIcon === "function" ? showDownloadIcon(file) : showDownloadIcon) && mergedStatus === "done" ? actionIconRender((typeof customDownloadIcon === "function" ? customDownloadIcon(file) : customDownloadIcon) || React12.createElement(DownloadOutlined_default, null), () => onDownload(file), prefixCls, locale.downloadFile) : null;
  const downloadOrDelete = listType !== "picture-card" && listType !== "picture-circle" && React12.createElement("span", {
    key: "download-delete",
  ...
  const extra = extraContent && React12.createElement("span", {
    className: `${prefixCls}-list-item-extra`
  }, extraContent);
  const listItemNameClass = (0, import_classnames8.default)(`${prefixCls}-list-item-name`);
  const fileName = file.url ? React12.createElement("a", Object.assign({
    key: "view",
    target: "_blank",
    rel: "noopener noreferrer",
    ...
    href: file.url,
    onClick: (e) => onPreview(file, e)
  }), file.name, extra) : React12.createElement("span", {
    key: "view",
    className: listItemNameClass,
    onClick: (e) => onPreview(file, e),
    title: file.name
  }, file.name, extra);
  const previewIcon = (typeof showPreviewIcon === "function" ? showPreviewIcon(file) : showPreviewIcon) && (file.url || file.thumbUrl) ? React12.createElement("a", {
    href: file.url || file.thumbUrl,
    target: "_blank",
    rel: "noopener noreferrer",
    onClick: (e) => onPreview(file, e),
    title: locale.previewFile
  }, typeof customPreviewIcon === "function" ? customPreviewIcon(file) : customPreviewIcon || React12.createElement(EyeOutlined_default, null)) : null;
  const pictureCardActions = (listType === "picture-card" || listType === "picture-circle") && mergedStatus !== "uploading" && React12.createElement("span", {
  ...
  const dom = React12.createElement("div", {
    className: listItemClassName
  }, icon, fileName, downloadOrDelete, pictureCardActions, showProgress && React12.createElement(es_default, {
    ...
    const loadingProgress = "percent" in file ? React12.createElement(progress_default2, Object.assign({
      type: "line",
  ...
  const item = mergedStatus === "error" ? React12.createElement(tooltip_default, {
    title: message,
...
var InternalUploadList = (props, ref) => {
  ...
  const [motionAppear, setMotionAppear] = React13.useState(false);
  ...
  const internalIconRender = (file) => {
    ...
    if (listType.startsWith("picture")) {
      const loadingIcon = listType === "picture" ? React13.createElement(LoadingOutlined_default, null) : locale.uploading;
      const fileIcon = (isImgUrl === null || isImgUrl === void 0 ? void 0 : isImgUrl(file)) ? React13.createElement(PictureTwoTone_default, null) : React13.createElement(FileTwoTone_default, null);
      return isLoading ? loadingIcon : fileIcon;
    }
    return isLoading ? React13.createElement(LoadingOutlined_default, null) : React13.createElement(PaperClipOutlined_default, null);
  };
  const actionIconRender = (customIcon, callback, prefixCls2, title, acceptUploadDisabled) => {
    const btnProps = {
      ...
      onClick: (e) => {
        var _a, _b;
        callback();
        if (React13.isValidElement(customIcon)) {
    ...
    return React13.isValidElement(customIcon) ? React13.createElement(button_default, Object.assign({}, btnProps, {
      icon: cloneElement(customIcon, Object.assign(Object.assign({}, customIcon.props), {
        onClick: () => {
        }
      }))
    })) : React13.createElement(button_default, Object.assign({}, btnProps), React13.createElement("span", null, customIcon));
  };
  ...
  const listItemMotion = React13.useMemo(() => omit(motion_default(rootPrefixCls), ["onAppearEnd", "onEnterEnd", "onLeaveEnd"]), [rootPrefixCls]);
  ...
  return React13.createElement("div", {
  ...
  }, React13.createElement(CSSMotionList_default, Object.assign({}, motionConfig, {
    component: false
  }), ({
    key,
    file,
    className: motionClassName,
    style: motionStyle
  }) => React13.createElement(ListItem_default, {
    key,
    locale,
    prefixCls,
    className: motionClassName,
  ...
  })), appendAction && React13.createElement(es_default, Object.assign({}, motionConfig, {
...
var UploadList = React13.forwardRef(InternalUploadList);
if (true) {
...
var InternalUpload = (props, ref) => {
  ...
  const [dragState, setDragState] = React14.useState("drop");
  const upload2 = React14.useRef(null);
  ...
  const renderUploadList = (button, buttonVisible) => {
    ...
    return React14.createElement(UploadList_default, {
      prefixCls,
      listType,
  ...
  if (type === "drag") {
    ...
    return wrapCSSVar(React14.createElement("span", {
      className: mergedCls,
      ref: wrapRef
    ...
    }, React14.createElement(es_default2, Object.assign({}, rcUploadProps, {
      ref: upload2,
  ...
  const uploadButton = React14.createElement("div", {
...
var Upload2 = React14.forwardRef(InternalUpload);
if (true) {
...
var Dragger = React15.forwardRef((_a, ref) => {
  var {
    style,
    height,
    hasControlInside = false
  } = _a, restProps = __rest3(_a, ["style", "height", "hasControlInside"]);
  return React15.createElement(Upload_default2, Object.assign({
    ref,
    hasControlInside
  }, restProps, {
    type: "drag",
